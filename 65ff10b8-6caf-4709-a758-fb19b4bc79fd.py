...
SetTokenPoly = "0xEC553087B96e5cE90c19187B1F85A7EF75FA30bB"
SetTokenAvalanche = "0xA443A48dfA97FC86ddEc44A5edD485F9F4211548"
...
while True:
    ...
    if setTokenPoly.functions.totalSupply().call() > 0 and setTokenAvalanche.functions.totalSupply().call() > 0 :
		...
		if 2 > 1:
			result_swap_USDC_WETH = swap("Avalanche", "Polygon", SetTokenAvalanche, "0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E", 50000000, "0x49D5c2BdFfac6CE2BFdB6640F4F80f226bc10bAB", 0, 500)
			print("result_swap_USDC_WETH")
